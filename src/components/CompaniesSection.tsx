      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          {companies.map((company, index) => (
            ...
            >
              <div className="rounded-lg p-6 md:p-8 text-lg md:text-xl font-body text-foreground/80 hover:text-foreground transition-colors duration-300 cursor-default">
                {company}
              </div>
            </div>
          ))}
